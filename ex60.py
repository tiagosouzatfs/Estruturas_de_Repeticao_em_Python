...
contador = 0
maior = 0
menor = 10000000000000000000000000000 # coloquei esse número enorme apenas para referência com a troca do menor consumo, pq se for zero sempre vai ser zero
somadorPares = 0
contadorPares = 0
somadorImpares = 0
contadorImpares = 0
